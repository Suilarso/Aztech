...
//extern const unsigned char memory_bank_0[];  //SJ5080313 - Not used
...
#define FADE_TIME_3   ((unsigned long)1400*WDT_CYCLES/SMCLK_KHZ)  //SJ5260413 - For our project to work, this has to be 1100.
#define FADE_TIME_4   ((unsigned long)2000*WDT_CYCLES/SMCLK_KHZ)  //SJ5260413 - Below onward, does not work in our case.
...
#define  FADE_RATE                  4  
#define  FADE_TIME                  5
#define  SHORT_ADDRESS              6  //SJ2220113 - SJEXT_ADDR: Since no longer use org flash location, no change
#define  GROUP_0_7                  7
#define  GROUP_8_F                  8
#define  SCENE_0                    9
#define  SCENE_1                    10
...
#if 1
#define  AZ_PROTOCOL_VER  58   //SJ2260213 - Location for protocol version number
#define  AZ_DAT_STRUCT_VER 59  //SJ2260213 - Location for data structure version number
...
//#define  TYPE_INDICATOR      6   //SJ1171212 - SJNOTE: !!!!! REMEMBER SWITCH_CONTROLLER !!!!!
#define  TYPE_INDICATOR      7   //SJ2160413 - For DEV_7 light: On - off light controller (bulb)
