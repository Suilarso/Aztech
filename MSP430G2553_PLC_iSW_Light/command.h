...
//--- SJ2140812 - We use 0x0A as device discovery -------------------
#if 1
  //#define AZ_SEEK_DEVICE      0x0A
  //#define AZ_REQUEST_DETACH   0x0B  //SJ4300812 - New
  //#define AZ_SENSOR_DETECT    0x0D  //SJ1170912
  //#define AZ_DEVICE_ERROR     0x0E
  #define AZ_PROPRIETARY_CMD  0x0A  //SJ2181212 - Aztech proprietary extended command
  #define AZ_RANDOMISE_DEVICE 0x0B
  #define AZ_CONTINOUS_PRESS  0x0C  //SJ5190413 - Reserved for continous key pressed
  #define AZ_SWITCH_IDENTITY  0x0D  //SJ4131212 - Used to indicate to GUI that the device pressed is a switch

  //SJ4201212 - Below macroes are meant to occupy location 67 of data packet
  ...
  #define AZ_EXT_CMD_REVERSE   0x10
  #define AZ_STEPPING_LEVEL    0x11

  #define AZ_STORE_EXP_SCENE   0xBD  //SJ4100113 - equiv 189
  #define AZ_REMOVE_EXP_SCENE  0xBE  //SJ4100113 - equiv 190
  #define AZ_GOTO_EXP_SCENE    0xBF  //SJ4100113 - equiv 191
#endif
//--- SJ2140812 - END. device discovery -----------------------------
...
#define STORE_THE_DTR_AS_SCENE_0  0x40   //SJ5070912 - 64 in base 10
...
#define STORE_THE_DTR_AS_SCENE_F  0x4F   //SJ5070912 - 79 in base 10
...
#define ADD_TO_GROUP_0      0x60  //SJ4130912 - equiv 96
...
#define ADD_TO_GROUP_7      0x67  //SJ4130912 - equiv 103
#define ADD_TO_GROUP_8      0x68  //SJ4130912 - equiv 104
...
#define ADD_TO_GROUP_F      0x6F  //SJ4130912 - equiv 111
